...
def build(
    ...
    *,
    ...
    """
    from mobius.integrations.transformers import build_transformers_model
    ...
    # Kept below temporarily so third-party patches against this private module
    # continue to resolve during the integration-module migration.
    import transformers
