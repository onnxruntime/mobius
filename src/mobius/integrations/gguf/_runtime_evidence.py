...
_STARCODER2_Q2_K_ORT_GENAI = GGUFRuntimeEvidence(
    ...
    import_route='{"architecture":"starcoder2","config_sha256":"f65598dc2d19c5537d47e6fd4eb619e51804f20a3b7069f73bd6d1036c661e04","execution_provider":"cpu","model_type":"starcoder2","module_type":"starcoder2","preserve_quantization":false,"registry_import":{"config_key_map":null,"config_postprocessor":null,"llama_qk_permute":false,"offset_norm":false,"required_metadata":[],"rope_interleave":false,"tensor_processor":null,"v_head_reorder":false,"vlm_builder":null},"route_schema":1,"static_cache":false,"task":{"class":"builtins.str","state":"text-generation"},"tensor_map_recipe":["llama"]}',
    source_fidelity=False,
    storage_quantized=False,
    target_storage_format="float",
    compute_mode="float operators",
    graph_files=_LOW_COST_GRAPH_FILES,
    graph_sha256="7c1a2391e2939b5422342576a8e48983b91e374bae4346080b69dcff735dd248",
    runtime_package_files=_LOW_COST_RUNTIME_PACKAGE_FILES,
    runtime_package_sha256="193949a8afebd49870689394711de6e270a3270670e60e2e8ed172267901671f",
