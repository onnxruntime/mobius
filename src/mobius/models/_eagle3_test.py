...
class TestEagle3SpeculatorsConfig:
    ...
    def test_distinct_target_hidden_width_sizes_fc_input(self):
        model = Eagle3DraftModel(_eagle3_config(target_hidden_size=128))
        assert model.fc.weight.shape == (64, 3 * 128)
