...
def test_qwen_vl_returns_hf_source_paths(monkeypatch):
    ...
    assert components["decoder"].source_path == "model.language_model"
    assert components["vision_encoder"].source_path == "model.visual"
    assert components["embedding"].source_path == "model.language_model.embed_tokens"
