...
from mobius.tasks._vibevoice_asr import VibeVoiceASRStreamingTask, VibeVoiceASRTask
...
TASK_REGISTRY: dict[str, type[ModelTask]] = {
    ...
    "vibevoice-asr-streaming": VibeVoiceASRStreamingTask,
