...
_REGISTRATIONS: dict[str, ModelRegistration] = {
    ...
    "granite_speech5_ctc": ModelRegistration(
        GraniteSpeech5ForCTCModel,
        task="feature-ctc-asr",
        config_class=GraniteSpeech5CTCConfig,
        test_model_id="ibm-granite/granite-speech-5.0-470m-turboctc",
        family="granite-speech",
        variant="chunked-conformer-ctc",
        test_revision="7e74c6438b7cfb5090cb6a131538f5e8515a7de3",
    ),
