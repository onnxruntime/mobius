...
CAUSAL_LM_CONFIGS: list[tuple[str, dict, bool]] = [
    ...
    # recurrent_gemma: hybrid RG-LRU + GQA attention (Griffin, requires RecurrentGemmaConfig)
    (
        "recurrent_gemma",
        {
            "_config_cls": RecurrentGemmaConfig,
            "num_hidden_layers": 3,
            "num_attention_heads": 2,
            "num_key_value_heads": 2,
            "head_dim": TINY_HEAD_DIM,
            "hidden_size": TINY_HIDDEN,
            "intermediate_size": TINY_INTERMEDIATE // 2,
            "lru_width": TINY_HIDDEN,
            "conv1d_width": 4,
            "logits_soft_cap": 30.0,
            "hidden_act": "gelu_pytorch_tanh",
            "layer_types": ["recurrent", "recurrent", "full_attention"],
            "attn_o_bias": True,
            "mlp_bias": True,
        },
        True,
...
VISION_CONFIGS: list[tuple[str, dict, bool]] = [
    ...
    (
        "sam",
        {
            ...
            "qkv_bias": True,
            "layer_norm_eps": 1e-6,
            "image_embedding_size": 4,  # image_size // patch_size
            "num_pos_feats": 8,
            "mask_input_channels": 16,
            "num_point_embeddings": 4,
            "mask_num_attention_heads": 2,
            "mask_num_hidden_layers": 2,
            "mask_intermediate_size": 32,
...
DETECTION_CONFIGS: list[tuple[str, dict, bool]] = [
    ...
    (
        "grounding-dino",
        {
            "_config_cls": GroundingDinoConfig,
            "d_model": 32,
            "num_queries": 4,
            "encoder_layers": 1,
            "decoder_layers": 2,
...
SPEECH_CONFIGS: list[tuple[str, dict, bool]] = [
    ...
    # --- Moonshine (lightweight ASR, conv frontend + RoPE encoder-decoder) ---
    (
        "moonshine",
        {
