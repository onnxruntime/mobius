...
CAUSAL_LM_CONFIGS: list[tuple[str, dict, bool]] = [
    ...
    (
        "phimoe",
        {
            "moe": MoEConfig(num_local_experts=4, num_experts_per_tok=2),
            "partial_rotary_factor": 0.5,
            "rope_type": "longrope",
            "rope_scaling": {
                "short_factor": LONGROPE_FACTORS,
    ...
    ("falcon", {"alibi_config": AlibiConfig(parallel_attn=True, dual_ln=True)}, True),
    (
        "falcon_h1",
        ...
        {
            "alibi_config": AlibiConfig(dual_ln=True),
            "attn_qkv_bias": True,
            "num_key_value_heads": TINY_HEADS,
        },
        True,
    ...
    (
        ...
        {
            "moe": MoEConfig(
                num_local_experts=4, num_experts_per_tok=2, post_feedforward_norm=True
            ),
            "attn_qk_norm": True,
            "attn_qk_norm_full": True,
        },
    ...
    (
        ...
        # dual_ln=True: new_decoder_architecture uses separate ln_attn + ln_mlp.
        {
            "alibi_config": AlibiConfig(parallel_attn=True, dual_ln=True),
            "attn_qkv_bias": True,
            "num_key_value_heads": TINY_HEADS,
        },
        False,
