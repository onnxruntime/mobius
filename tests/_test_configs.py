...
_TINY_GLM5_NEXT_OVERRIDES = {
    "_config_cls": Glm5NextConfig,
    "num_hidden_layers": 4,
...
CAUSAL_LM_CONFIGS: list[tuple[str, dict, bool]] = [
    ...
    (
        "glm5_next_text",
        dict(_TINY_GLM5_NEXT_OVERRIDES),
        True,
    ),
    (
        "deepseek_v4",
        ...
        "glm5_next",
        {
            **_TINY_GLM5_NEXT_OVERRIDES,
            "vision": VisionConfig(
                ...
                spatial_merge_size=2,
                temporal_patch_size=2,
                projector_intermediate_size=128,
                swiglu_limit=10.0,
            ),
            "image_token_id": 250,
            "video_token_id": 251,
            "image_start_token_id": 246,
            "image_end_token_id": 247,
            "video_start_token_id": 248,
            "video_end_token_id": 249,
        },
        True,
    ),
    (
