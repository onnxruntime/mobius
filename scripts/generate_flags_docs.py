...
"""Auto-generate docs/feature-flags.md from the Flags dataclass.
...
Extraction strategy
-------------------
For each field in :class:`mobius._flags.Flags`:
