...
| `vibevoice_asr` | `VibeVoiceASRForConditionalGeneration` | `vibevoice-asr` | `microsoft/VibeVoice-ASR-HF`; `microsoft/VibeVoice-ASR-BitNet` (pinned dense-F32 conversion source; native I2_S/I8_S GGUF rejected) |
