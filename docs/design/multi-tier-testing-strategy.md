...
5. Run:  python -m pytest tests/*_integration_test.py -m integration -k "my_model"
...
| L3 | ✅ Causal LM + integration tests | ~116 types | `synthetic_parity_test.py` + `*_integration_test.py` |
