...
|---|---:|---|
| Architectures | 147 | graph verdicts: {'deferred': 59, 'rejected': 2, 'supported': 86}; importable: 85; quantized import: {'rejected': 27, 'supported': 120}; runtime: {'deferred': 144, 'rejected': 2, 'supported': 1} |
