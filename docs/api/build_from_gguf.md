...
|---|---:|---|
| Architectures | 147 | graph verdicts: {'deferred': 77, 'rejected': 2, 'supported': 68}; importable: 67; quantized import: {'rejected': 16, 'supported': 131}; runtime: {'deferred': 144, 'rejected': 2, 'supported': 1} |
